...
Plugin Name: DIW Youtube
Description: Affiche une vidéo en 16/9 provenant de youtube ex : [youtube]0g9poWKKpbU[/youtube]
Author: AdeuxL
Version: 1.0

*/

/* 1. Déclarer une fct° de création de Shortcode */
...
/*  $html = '<div class="embed-responsive embed-responsive-16by9">
    ...
    src="https://www.youtube.com/embed/'.$content.'"></iframe>
    </div>';    la on mit 16by9   */

// la on a ajouté la proba d'un autre format proposé (lg 26) dc :
